...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained_weights", type=str,default="/home/mia_dev/xeroblade2/PyTorch-YOLOv3-master/checkpoints/yolov3_ckpt_99.pth", help="if specified starts from checkpoint model")
