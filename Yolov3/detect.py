...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_folder", type=str, default="/home/mia_dev/xeroblade2/dataset/test/2021-03-22_21-49-34", help="path to dataset")
    ...
    parser.add_argument("--weights_path", type=str, default="/home/mia_dev/xeroblade2/PyTorch-YOLOv3-master/checkpoints/yolov3_ckpt_99.pth", help="path to weights file")
    ...
    parser.add_argument("--checkpoint_model", type=str, default="/home/mia_dev/xeroblade2/PyTorch-YOLOv3-master/checkpoints/yolov3_ckpt_99.pth", help="path to checkpoint model")
