...
class VOCdataset(torch.utils.data.Dataset):
    def __init__(self):
        self.category = ['nopon']
        self.img_root_dir = os.path.join('/home/mia_dev/xeroblade2/dataset/train/voc/img/')
        self.img_list = os.path.join('/home/mia_dev/xeroblade2/dataset/train/voc/train.txt')
        self.annotations_dir = os.path.join('/home/mia_dev/xeroblade2/dataset/train/voc/xmlannotation/')
